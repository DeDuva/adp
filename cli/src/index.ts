...
export const COMMANDS: Command[] = [
  ...
  { path: ["bakeoff"], args: "--repo <owner>/<repo> --intent <uuid|#issue> --harness <a,b,c> [--orchestrator <name>] [--launch] [--concurrency <n>]",
  ...
  { path: ["reimplement"], args: "<sha> [--harness <name>] [--model <name>] [--launch] [--compare] [--repo <owner>/<repo>]",
