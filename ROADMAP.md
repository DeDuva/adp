...
- **Next:** the re-scoped M4's remaining work, none of it budget-gated — the audit-reconciliation
  test exit criterion 4 names, and ratifying runner isolation as met. Then the serial-base-case forward work: author-independent
